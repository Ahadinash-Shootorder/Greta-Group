<section class="industry-page-hero">
    <div class="container">
        <!-- Mobile Image -->
        <img 
            src="img/banner/greta-metal-mob-banner.webp" 
        ...
        <!-- Desktop Image -->
        <img 
            src="img/banner/greta-metal-desk-banner.webp" 
        ...
        <div class="industry-page-hero-content">
            <div class="industry-page-hero-title-wrapper">
                <h1 class="industry-page-hero-title">Greta Metal PTE Ltd</h1>
                <p class="industry-page-hero-subtitle">Trusted worldwide since 2001, delivering quality with integrity</p>
            </div>
        </div>
    </div>
</section>