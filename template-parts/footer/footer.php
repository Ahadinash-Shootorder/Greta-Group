                ...
                <!-- <div class="col-lg-3 col-md-6 footer-widget">
                    <div class="footer-widget widget-twitter">
                        ...
                        <div class="twitter-post">
                            <p class="post-pra"><a class="fw-b" href="#">@Noyon10 Hi,</a> semper orci curabitur orcialiquet vivamus cons<a href="#">https://themeforest.net</a></p>
                        </div>
                        <div class="twitter-post">
                            <p class="post-pra"><a class="fw-b" href="#">@Noyon10 Hi,</a> semper orci curabitur orcialiquet vivamus cons <a href="#">https://themeforest.net</a></p>
                        </div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="inner-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="inner-text">info@greta.sg, info.kusum@greta.in</span>
                                    </div>
                                </div>
                            </div>
                            <div class="inner-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="inner-text">+65 6223 0152, +65 62230243</span>
                                    </div>
                                </div>
                            </div>
                        </div>
