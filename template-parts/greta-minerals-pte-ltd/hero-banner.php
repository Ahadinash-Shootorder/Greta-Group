<section class="industry-page-hero">
    <div class="container">
        <!-- Mobile Image -->
        <img 
            src="img/banner/lithium-mob-banner.webp" 
        ...
        <!-- Desktop Image -->
        <img 
            src="img/banner/lithium-desk-banner.webp" 
        ...
        <div class="industry-page-hero-content">
            <div class="industry-page-hero-title-wrapper">
                <h1 class="industry-page-hero-title">Greta Minerals PTE LTD</h1>
                <p class="industry-page-hero-subtitle">Securing Critical Minerals for a Sustainable Tomorrow  </p>
            </div>
        </div>
    </div>
</section>