  ...
  <form action="send-mail.php" method="POST" enctype="multipart/form-data">
    ...
    <div style="display:flex; gap:30px; margin-bottom:25px;">
      <input type="text" name="name" placeholder="Name*" required
        style="width:50%; padding:16px; border:1px solid #ccc;">
    ...
    <div style="display:flex; gap:30px; margin-bottom:25px;">
      ...
      <input type="text" name="skills" placeholder="Skills" style="width:50%; padding:16px; border:1px solid #ccc;">
    </div>

    <div style="display:flex; align-items:center; margin-bottom:10px;">
      <input type="file" name="resume" required style="flex:1; padding:14px; border:1px solid #ccc;">
    </div>

    <div style="margin-top:30px;">
      <button type="submit" style="background:#0047ab; color:#fff; padding:14px 40px; border:none;">
        Submit
      </button>
    </div>
